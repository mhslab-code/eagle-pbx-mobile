...
Na revisão `0.1.56`, a atividade principal deixa de ser aberta antes da
confirmação SIP. O aceite é solicitado pelo serviço e a troca de tela ocorre
somente após `CONNECTED`, eliminando a etapa visual “Chamada recebida”.
...
Na revisão `0.1.61`, a configuração SIP aprovada é mantida cifrada pelo Android
Keystore e restaurada assim que o processo nasce. Se uma atualização ainda não
